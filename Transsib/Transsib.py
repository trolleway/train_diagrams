...
stationcalls[trainnumber].append(8523) #Хабаровск
traintimes[trainnumber].append('2022-07-15 10:00')
...
traintimes[trainnumber] = list()
stationcalls[trainnumber] = list()
traintimes[trainnumber].append('2022-07-11 07:44')
stationcalls[trainnumber].append(5185)
traintimes[trainnumber].append('2022-07-11 08:07')
stationcalls[trainnumber].append(5185)
traintimes[trainnumber].append('2022-07-11 15:09')
stationcalls[trainnumber].append(5641) #Улан-Удэ
traintimes[trainnumber].append('2022-07-12 01:37')
stationcalls[trainnumber].append(6198) #Чита
traintimes[trainnumber].append('2022-07-12 02:13')
stationcalls[trainnumber].append(6198) #Чита
traintimes[trainnumber].append('2022-07-13 07:49')
stationcalls[trainnumber].append(7807) #Свободный
...
x_bounds = [datetime.datetime(2022, 7, 11,6,0), datetime.datetime(2022, 7, 15,12,5)]
#Size of figure
figsize=(19,9)
